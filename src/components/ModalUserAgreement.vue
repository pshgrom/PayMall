  ...
  <div v-if="isVisible" class="modal-overlay" @click="closeOnOverlayClick">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-wrapper">
        ...
        <p>
          7.2. Пользователь имеет право запросить возврат средств на реквизиты с которы была
          произведена оплата, если оплаченная сумма не была зачислена на его аккаунт STEAM в течение
          10 календарных дней. Все остальные случаи, как правило, не предполагают возможности
          возврата денежных средств. При осуществлении возврата могут быть удержаны комиссии
          платежных систем. В случае возникновения вопросов или проблем, требующих внимания в
          контексте возврата платежей, настоятельно рекомендуем написать на paymallcase@gmail.com.
        </p>
        <p></p>
      </div>
    </div>
