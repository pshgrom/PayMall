  ...
  <div v-if="isVisible" class="modal-overlay" @click="closeOnOverlayClick">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-wrapper">
        ...
        <h2>7. Условия осуществления платежей и возвратов:</h2>
        <p>
          7.1. Вы обязуетесь урегулировать все необходимые платежи, включая налоги, банковские и
          другие комиссии, установленные третьими лицами, как со своей стороны, так и со стороны
          любого пользователя, оперирующего вашим зарегистрированным аккаунтом.
        </p>
        <p>
          7.2. Пользователь имеет право запросить возврат средств, если оплаченная сумма не была
          зачислена на его аккаунт STEAM в течение 10 календарных дней. Сумма будети переведена на
          реквизиты с которых была произведена оплата в течении 7 дней. Все остальные случаи, как
          правило, не предполагают возможности возврата денежных средств. При осуществлении возврата
          могут быть удержаны комиссии платежных систем. В случае возникновения вопросов или
          проблем, требующих внимания в контексте возврата платежей, настоятельно рекомендуем
          написать на paymallcase@gmail.com.
        </p>
        <p></p>
      </div>
    </div>
